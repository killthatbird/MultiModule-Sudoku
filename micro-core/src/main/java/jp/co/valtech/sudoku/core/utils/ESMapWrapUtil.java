...
public class ESMapWrapUtil {

	/**
	 * リストボックスに使用するmapを返却します。
	 * mapの要素は数独のタイプ種別を保持します。
	 *
